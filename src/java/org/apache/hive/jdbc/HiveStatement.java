...
public class HiveStatement implements java.sql.Statement {
  ...
  protected TSessionHandle sessHandle;
  Map<String,String> sessConf = new HashMap<String,String>();
  protected int fetchSize = 50;
  protected boolean isScrollableResultset = false;
  /**
   ...
   * successfully.
   */
  protected boolean isExecuteStatementFailed = false;
  ...
  /**
   * when coordinator bad, reconnection the backup coordinator
   * and reset client,sessHandle,stmtHandle.
   */
  void reInitializeStmt() throws SQLException {
    if (this.connection.hasBackUp()) {
      LOGGER.info("Reinitialize stmt start.");
      this.connection.reConnection();
      this.client = this.connection.getClient();
      this.sessHandle = this.connection.getSessHandle();
      this.stmtHandle = null;
      LOGGER.info("Reinitialize stmt over.");
    }
  }
