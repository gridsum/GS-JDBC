 ...
 *
 */
public class ImpalaDriver implements Driver {
    static {
        try {
            java.sql.DriverManager.registerDriver(new ImpalaDriver());
    ...
    public Connection connect(String url, Properties info) throws SQLException {
        return acceptsURL(url) ? new ImpalaConnection(url, info) : null;
    }
    ...
    static int getMajorDriverVersion() {
        int version = -1;
        try {
            String fullVersion = ImpalaDriver.fetchManifestAttribute(
    ...
    public int getMajorVersion() {
        return ImpalaDriver.getMajorDriverVersion();
    }
    ...
    public int getMinorVersion() {
        return ImpalaDriver.getMinorDriverVersion();
    }
    ...
    private static synchronized void loadManifestAttributes() throws IOException {
        ...
        Class<?> clazz = ImpalaDriver.class;
